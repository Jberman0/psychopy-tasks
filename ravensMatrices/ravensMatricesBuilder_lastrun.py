...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Josh\\Downloads\\psychopy-tasks-main\\psychopy-tasks-main\\ravensMatrices\\ravensMatricesBuilder_lastrun.py',
...
_space_end_allKeys = []
# keep track of which components have finished
endComponents = [endText, space_end]
